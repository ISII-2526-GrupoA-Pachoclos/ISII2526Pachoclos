using AppForSEII2526.API.ISII2526Pachoclos.LogViewer;
...
namespace ISII2526Pachoclos.LogViewer
{
    public class Subscriber : IDisposable
    {
        ...
        public void StartConsuming()
        {
            try
            {
                ...
                var tempQueue = _channel.QueueDeclare(
                    queue: "", // nombre vacio = cola temporal
                    durable: false,
                    exclusive: true,
                    autoDelete: true);
                ...
                _channel.QueueBind(
                    ...
                    routingKey: _routingKey); // routing key vacia para fanout
        ...
        private void DisplayLogEntry(LogEntry logEntry)
        {
            ...
            // Cambiar color segun el nivel de log
            ...
            if (!string.IsNullOrEmpty(logEntry.Exception))
            {
                ...
                Console.WriteLine($"   Excepcion: {logEntry.Exception}");
                Console.ForegroundColor = logEntry.LogLevel switch
                {
                    "Error" or "Critical" => ConsoleColor.Red,
                    "Warning" => ConsoleColor.Yellow,
