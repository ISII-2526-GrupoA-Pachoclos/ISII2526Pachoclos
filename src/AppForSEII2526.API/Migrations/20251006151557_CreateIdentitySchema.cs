    ...
    public partial class CreateIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_alquilarItem", x => new { x.idAlquiler, x.idHerramienta });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComprarItem", x => new { x.idCompra, x.idHerramienta });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfertaItem", x => new { x.idOferta, x.idHerramienta });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_alquilarItem_alquilarid",
                table: "alquilarItem",
                column: "alquilarid");
